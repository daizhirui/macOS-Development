...
- (NSInteger)numberOfItemsForScrubber:(NSScrubber *)scrubber
{
    ...
    {
        return 10;  // For text scrubber item, we only use an aribtary 10.
    }
}
...
// User chose an item inside the scrubber.
...
{
    // User performed the initial touch on the scrubber.
}

- (void)didFinishInteractingWithScrubber:(NSScrubber *)scrubber
{
    // User released their touch on the scrubber.
}

- (void)didCancelInteractingWithScrubber:(NSScrubber *)scrubber
{
    // User cancelled the interaction on the scrubber.
}
